                ...
                switch gnsslogdata.ConstellationType(i)
                    case {1, 5, 6}
                        ...
                        [X,Y,Z] = SatelliteECEFs.eph_to_ecef(...
                            constellation_ephemeris.sqrtA(svid), ...
                            constellation_ephemeris.e(svid), ...
                            constellation_ephemeris.i0(svid), ...
                            constellation_ephemeris.omega(svid), ...
                            constellation_ephemeris.Delta_n(svid), ...
                            constellation_ephemeris.M0(svid), ...
                            constellation_ephemeris.GPS_week_num(svid), ...
                            constellation_ephemeris.Cuc(svid), ...
                            constellation_ephemeris.Cus(svid), ...
                            constellation_ephemeris.Cic(svid), ...
                            constellation_ephemeris.Cis(svid), ...
                            constellation_ephemeris.Crc(svid), ...
                            constellation_ephemeris.Crs(svid), ...
                            constellation_ephemeris.OMEGA(svid), ...
                            constellation_ephemeris.OMEGA_DOT(svid), ...
                            constellation_ephemeris.I_DOT(svid), ...
                            constellation_ephemeris.Toe(svid), ...
                            measurement_week, ...
                            measurement_time);
