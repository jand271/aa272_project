                ...
                switch gnsslogdata.ConstellationType(i)
                    case 1
                        ...
                        [X,Y,Z] = SatelliteECEFs.eph_to_ecef(...
                            ephemeris.gps.sqrtA(svid), ...
                            ephemeris.gps.Eccentricity(svid), ...
                            ephemeris.gps.Io(svid), ...
                            ephemeris.gps.omega(svid), ...
                            ephemeris.gps.DeltaN(svid), ...
                            ephemeris.gps.M0(svid), ...
                            ephemeris.gps.GPSWeek(svid), ...
                            ephemeris.gps.Cuc(svid), ...
                            ephemeris.gps.Cus(svid), ...
                            ephemeris.gps.Cic(svid), ...
                            ephemeris.gps.Cis(svid), ...
                            ephemeris.gps.Crc(svid), ...
                            ephemeris.gps.Crs(svid), ...
                            ephemeris.gps.Omega0(svid), ...
                            ephemeris.gps.OmegaDot(svid), ...
                            ephemeris.gps.IDOT(svid), ...
                            ephemeris.gps.Toe(svid), ...
                            measurement_week, ...
                            measurement_time);
                        B = ephemeris.gps.SVclockBias(svid) * SatelliteECEFs.c;
                    otherwise
