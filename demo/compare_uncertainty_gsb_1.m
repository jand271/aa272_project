...
title('Comparison of Uncertainty Strategies GSB');
xlabel('x ECEF');
ylabel('y ECEF');
axis equal
legend('raw','BS7','BS7 samples','BS8','BS9','BS10','BS11','BS12','BS13','BS14','DOP','static','location','best');

saveas(gcf,'GSB_1_BS.png');
